!function (t) {
    ...
    var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        function t() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = e.name, o = e.fn,
                i = e.type, a = void 0 === i ? "usr" : i, s = e.shell, u = void 0 === s ? void 0 : s, c = e.man,
                l = void 0 === c ? "" : c;
    ...
    var o = function () {
        ...
        function t() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = e.name,
                o = void 0 === n ? "" : n, i = e.type, a = void 0 === i ? "file" : i, s = e.content,
                u = void 0 === s ? "" : s;
    ...
    (function (e) {
        ...
        }(), u = n(5), c = n(4), l = n(8), f = function (t) {
            function u() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = t.filesystem,
                    i = void 0 === e ? void 0 : e, s = t.commands, f = void 0 === s ? void 0 : s, h = t.env,
                    d = void 0 === h ? {} : h;
                r(this, u);
    ...
    var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        return a(t, [{
            key: "initFs", value: function (t) {
                this.buildVirtualFs(t);
                var e = new u({name: "/", content: t, type: "dir"});
                return e
            }
        }, {
            key: "buildVirtualFs", value: function (t) {
                for (var e in t) t.hasOwnProperty(e) && ("object" !== i(t[e]) || Array.isArray(t[e]) ? t[e] = new u({
                    name: e,
                    content: t[e]
                }) : (t[e] = new u({name: e, content: t[e], type: "dir"}), this.buildVirtualFs(t[e].content)))
            }
        }, {
            key: "pathStringToArray", value: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
            ...
            key: "pathArrayToString", value: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
            ...
            key: "getNode", value: function () {
                ...
                return {path: t, pathArray: e, node: n}
            }
        }, {
            key: "changeDir", value: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", e = void 0;
                if (".." === t) {
            ...
            key: "getCurrentDirectory", value: function () {
                var t = void 0;
                try {
    ...
    var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        return i(t, [{
            ...
            key: "registerCommands", value: function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : void 0, r = n(6);
                if (e) {
    ...
    var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
    }, o = n(15), i = o.name, a = o.version, s = o.description, u = o.repository, c = o.author, l = o.license;
    t.exports = {
        help: {
            name: "help",
            type: "builtin",
        ...
        whoami: {
            name: "whoami", type: "builtin", man: "Current user", fn: function () {
                return this.shell.user
            }
        },
        about: {
            name: "about", type: "builtin", man: "About this project", fn: function () {
                var t = "";
                return t += "name: " + i + "\n", t += "version: " + a + "\n", t += "description: " + s + "\n", t += "repository: " + u + "\n", t += "author: " + c + "\n", t += "license: " + l + "\n"
            }
        },
        pwd: {
            name: "pwd", type: "builtin", man: "Print current working directory", fn: function () {
        ...
        printenv: {
            name: "printenv", type: "builtin", man: "Return environment variables", fn: function () {
                var t = this.shell.env, e = "";
        ...
        ls: {
            ...
            fn: function () {
                ...
                t._.length || t._.push(".");
                var e = t._.join(), n = void 0, r = "";
                try {
                    n = this.shell.fs.listDir(e)
                } catch (t) {
                    throw t
                }
                for (var o in n) n.hasOwnProperty(o) && (r += n[o].permission + "\t" + n[o].user + " " + n[o].group + "\t" + n[o].name + "\n");
                return r
            }
        },
        cat: {
            ...
            fn: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {_: ["./"]}, e = t._.join(),
                    n = void 0;
                try {
        ...
        man: {
            name: "man", type: "builtin", man: "Command manual, takes one argument, command name", fn: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
    ...
    t.exports = {
        ...
        etc: {apache2: {"apache2.conf": "Not What you were looking for :)"}},
        home: {guest: {docs: {"mydoc.md": "TestFile", "mydoc2.md": "TestFile2", "mydoc3.md": "TestFile3"}}},
        root: {".zshrc": "not even close :)", ".oh-my-zsh": {themes: {}}}
    }
}, function (t, e, n) {
    "use strict";
    (function (e) {
        var n = e || window, r = n.location;
        t.exports = {USER: "root", HOSTNAME: r && r.hostname.length ? r.hostname : "my.host.me"}
    }).call(e, n(0))
}, function (t, e) {
    function n() {
    ...
    (function (t, e) {
        !function (t, n) {
            ...
            if (!t.setImmediate) {
                var d, p = 1, y = {}, m = !1, v = t.document, b = Object.getPrototypeOf && Object.getPrototypeOf(t);
    ...
    var o = function () {
        ...
        function t(e) {
            ...
            if (this.command = n[0], this._ = [], n.length) {
                ...
                if (!Object.assign) {
                    for (var i in o) o.hasOwnProperty(i) && (this[i] = o[i]);
                    return !0
                }
        ...
        return o(t, [{
            key: "stringToArray", value: function (t) {
                return t.match(/[^\s"']+|"([^"]*)"|'([^']*)'/g)
            }
        }, {
            key: "parse", value: function (t) {
    ...
    !function (t) {
        ...
        function f() {
            return this.bodyUsed = !1, this._initBody = function (t) {
                if (this._bodyInit = t, t) if ("string" == typeof t) this._bodyText = t; else if (v.blob && Blob.prototype.isPrototypeOf(t)) this._bodyBlob = t; else if (v.formData && FormData.prototype.isPrototypeOf(t)) this._bodyFormData = t; else if (v.searchParams && URLSearchParams.prototype.isPrototypeOf(t)) this._bodyText = t.toString(); else if (v.arrayBuffer && v.blob && w(t)) this._bodyArrayBuffer = l(t.buffer), this._bodyInit = new Blob([this._bodyArrayBuffer]); else {
    ...
    var a = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        function e() {
            var t, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : void 0,
                i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            r(this, e);
            var a = o(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, i));
            if (!n) throw new Error("No wrapper element selector provided");
            try {
                if (a.container = document.querySelector(n), !a.container) throw new Error("new Terminal(): DOM element not found")
            } catch (t) {
                throw new Error("new Terminal(): Not valid DOM selector.")
            }
            return t = a.init(), o(a, t)
        }

        return i(e, t), s(e, [{
            key: "init", value: function () {
                var t = this;
                this.generateRow(), this.container.addEventListener("click", function (e) {
                    e.stopPropagation();
                    var n = t.container.querySelector(".current .terminal-input");
                    n && n.focus()
                })
            }
        }, {
            key: "generateRow", value: function () {
                var t = this, e = document.querySelector(".current.terminal-row");
                e && (e.classList.remove("current"), e.querySelector("input").disabled = !0);
                var n = document.querySelector(".terminal-input");
                n && (n.removeEventListener("input", this.resizeHandler), n.blur());
                var r = document.createElement("div");
                r.classList.add("current", "terminal-row"), r.innerHTML = "", r.innerHTML += '<span class="terminal-info">' + this.env.USER + "@" + this.env.HOSTNAME + " - " + this.fs.getCurrentDirectory() + " ➜ </span>", r.innerHTML += '<input type="text" class="terminal-input" size="2" style="cursor:none;">', this.container.appendChild(r);
                var o = this.container.querySelector(".current .terminal-input"),
                    i = this.container.querySelector(".current.terminal-row"), a = i.querySelector(".terminal-info"),
                    s = i.offsetWidth - a.offsetWidth - 20;
                return o.style.width = s + "px", o.addEventListener("keyup", function (e) {
                    return t.submitHandler(e)
                }), o.select(), this.container.scrollTop = this.container.scrollHeight + 1, o
            }
        }, {
            key: "generateOutput", value: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                    e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                Array.isArray(t) && (t = t.join("\n"));
                var n = document.createElement("pre");
                if (n.textContent = t, n.className = "terminal-output", this.container.appendChild(n), e) return this.generateRow()
            }
        }, {
            key: "clear", value: function () {
                return this.container.innerHTML = "", this.generateRow()
            }
        }, {
            key: "submitHandler", value: function (t) {
                ...
                if (13 == t.which || 13 == t.keyCode) {
                    ...
                    if ("clear" === n) return this.clear();
                    var r = this.run(n);
                    return r.then ? (this.generateOutput("Pending request...", !1), r.then(function (t) {
                        if ("object" === ("undefined" == typeof t ? "undefined" : a(t))) try {
                            t = JSON.stringify(t, null, 2)
                        } catch (t) {
                            return e.generateOutput("-fatal http: Response received but had a problem parsing it.")
                        }
                        return e.generateOutput(t)
                    }).catch(function (t) {
                        return e.generateOutput(t.message)
                    })) : (("object" === ("undefined" == typeof r ? "undefined" : a(r)) || Array.isArray(r)) && (r = JSON.stringify(r, null, 2)), this.generateOutput(r))
                }
            }
        }]), e
    }(u);
